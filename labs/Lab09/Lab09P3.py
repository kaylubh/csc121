...
def main():
    ...
    while True:
        ...
        # add the count to inventory_counts as item_name: count
        # if item_name is already in inventory_counts retrieves current value and increments it by count
        inventory_counts[item_name] = inventory_counts.get(item_name, 0) + item_count
        # add the cost to inventory_costs as item_name: unit_cost
        inventory_costs[item_name] = unit_cost
        # add the category to inventory_categories as item_name: category
